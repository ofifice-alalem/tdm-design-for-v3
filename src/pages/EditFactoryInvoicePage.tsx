...
const INVOICE_DATA = {
  id: '#FI-20260406-00006',
  supplier: 'مورد النسيج الأول',
  notes: '',
  items: [
    { id: 1, name: 'قماش قطني أبيض', buyPrice: 45, qty: 100, unitPrice: 45 },
    { id: 2, name: 'خيط بوليستر',    buyPrice: 12, qty: 50,  unitPrice: 12 },
  ],
};
...
export default function EditFactoryInvoicePage() {
    ...
    <div className="flex flex-col gap-6 h-full">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start w-full h-full min-h-0 pb-32 lg:pb-0">
        <div className="lg:hidden w-full">
          <ModernSelect label="اختيار المورد" defaultValue={INVOICE_DATA.supplier} options={['مورد النسيج الأول', 'مورد الخياطة المتحدة', 'مورد الأقمشة الحديثة']} />
        </div>
        ...
        <aside className="w-full lg:w-[400px] xl:w-[440px] shrink-0 flex flex-col gap-5 lg:sticky lg:top-0 lg:self-start">
          ...
          <SpatialCard title="ملاحظات" icon={<FileText className="w-5 h-5" />}>
            <textarea defaultValue={INVOICE_DATA.notes} className="spatial-input w-full min-h-[80px] resize-none rounded-[20px] p-5 text-sm font-bold" placeholder="أضف أي ملاحظات..." />
          </SpatialCard>
